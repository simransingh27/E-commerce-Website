...
namespace Vendi.App
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //})
              .AddGoogle(googleOptions => {
                  googleOptions.ClientId = "313347531394-hae27i8enatrtoivc6vq4frhh3d4vqog.apps.googleusercontent.com";
                  googleOptions.ClientSecret = "oag_34caPOPMbuHyPqYTw_E6";

              });
            //        services.AddIdentity<Vendi.Data.ApplicationUser, IdentityRole>(options =>
            //        {
        ...
        public   void Configure(IApplicationBuilder app, IHostingEnvironment env, RoleManager<IdentityRole> roleManager )
        {
            ...
            //});
            //   Initializer asd= new Initializer(roleManager);
            // await  asd.Initial();
        }
    }
}
